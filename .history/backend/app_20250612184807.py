...
def chat():
    ...
    try:
        ...
        # --- UPDATED PROMPT: Stricter instructions for direct, point-to-point response ---
...
def speak_text():
    ...
    try:
        ...
        # --- VERIFIED PAYLOAD STRUCTURE BASED ON SCREENSHOT ---
        # This payload only uses 'text' and 'target_language_code'.
        # If the Sarvam AI API requires more parameters for specific voices/models,
        # those parameters must be added to this payload structure.
        payload = {
            "text": text_to_speak,
            "target_language_code": sarvam_target_language_code,
        }
        ...
        if audio_content_base64:
            try:
                # Sarvam AI's /text-to-speech endpoint returns pure base64. No "data:" prefix to strip.
                audio_bytes = base64.b64decode(audio_content_base64)
                if audio_bytes and len(audio_bytes) > 100:
                    with open(f"sarvam_ai_output_temp.mp3", "wb") as f:
                        f.write(audio_bytes)
