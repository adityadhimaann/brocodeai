...
# google-generativeai
try:
    # Note: These imports are for synchronous clients.
...
def chat():
    ...
    try:
        ...
        # --- 3. Call Gemini LLM (Synchronous Call) ---
        print(f"DEBUG: Sending prompt to Gemini: {persona_prompt}")
        # Removed 'await' here and changed to synchronous method
        ...
        # --- 4. Text-to-Speech for Bot Response (Synchronous Call) ---
