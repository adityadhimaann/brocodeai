...
from flask_cors import CORS  # <--- Make sure this is present
...
app = Flask(__name__)
CORS(app) # <--- Make sure this line is present right after app = Flask(__name__)
...
if __name__ == '__main__':
    app.run(debug=True, host='0.0.0.0', port=5002) # Run on port 5002 <-- Confirmed from your screenshot