...
def chat():
    ...
    try:
        ...
        **Do NOT engage in conversational filler, greetings, pleasantries, or apologies.**
        ...
        Use the carryminati's,ashish chanchlani and other comedian youtube actors content to reply the user in sarcastic way but not in all the chat and replies .
        {petty_database_context}
