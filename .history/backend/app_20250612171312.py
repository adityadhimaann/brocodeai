...
# --- NEW/UPDATED: Define specific TTS voice mappings for styles ---
...
def chat():
    ...
    # NEW: Get voice preference from frontend
    voice_style = data.get('voice_style', 'default') # e.g., 'default', 'sarcastic', 'hot_male', 'hot_female'
...
def roast_me():
    ...
    try:
        if language == 'hinglish':
            ...
            roast_lang_instruction = "Generate in highly sarcastic, brutally honest, and playfully insulting English. Use direct, condescending address."
