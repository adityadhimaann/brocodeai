...
import { Loader2, Menu } from 'lucide-react'; // Import Menu icon for the SheetTrigger button
...
// Ensure these paths are correct relative to App.js (e.g., './components/ui/sheet')
import { Sheet, SheetContent, SheetTrigger, SheetClose } from './components/ui/sheet';
import { Button } from './components/ui/button'; // Button is used by SheetTrigger asChild
...
export default function App() {
  ...
  return (
    <div className="flex h-screen bg-zinc-950 text-zinc-100 font-inter antialiased overflow-hidden relative">
      ...
      {/* Sidebar (controlled by Sheet in App.js) */}
      <Sheet open={isSidebarOpen} onOpenChange={setIsSidebarOpen}>
        {/* SheetTrigger is here, making it a direct child of Sheet */}
        <SheetTrigger asChild>
          {/* This Button will replace the Menu button in ChatHeader. It directly opens the Sheet. */}
          <motion.button
            className="p-1 md:p-2 rounded-full bg-zinc-700 hover:bg-zinc-600 text-white focus:outline-none focus:ring-2 focus:ring-zinc-600 transition-colors duration-200 absolute top-3 left-3 md:static md:ml-4 z-50 md:z-auto"
        ...
        >
          ...
          <Sidebar
            toggleSidebar={() => setIsSidebarOpen(!isSidebarOpen)} // Pass toggle function to close from within Sidebar
      ...
      <div className={`flex flex-col flex-1 transition-all duration-300 ease-in-out
        ...
        <ChatHeader
          ...
          // Removed toggleSidebar prop as SheetTrigger is now in App.js
