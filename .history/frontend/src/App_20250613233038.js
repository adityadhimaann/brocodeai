...
import ScrollingHumorPanel from './components/ScrollingHumorPanel';
...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-zinc-950 text-zinc-100 font-inter antialiased overflow-hidden relative" style={{ '--panel-width-val': '300px', '--header-height': '64px' }}>
      ...
      />
      {showHumorPanels && (
        <div className="fixed inset-y-0 left-0 flex flex-col z-30" style={{ width: '300px', pointerEvents: 'none' }}>
          <ScrollingHumorPanel
            humorItems={[]} // TODO: Replace with actual humor items state
            direction="up"
            position="left"
            isLoading={false} // TODO: Replace with actual loading state
            error={null} // TODO: Replace with actual error state
            onRefresh={() => {}} // TODO: Replace with actual refresh handler
            onSpeakText={() => {}} // TODO: Replace with actual speak handler
            selectedLanguage={selectedLanguage}
      ...
      {showHumorPanels && (
        <div className="fixed inset-y-0 right-0 flex flex-col z-30" style={{ width: '300px', pointerEvents: 'none' }}>
          <ScrollingHumorPanel
            humorItems={[]} // TODO: Replace with actual humor items state
            direction="down"
            position="right"
