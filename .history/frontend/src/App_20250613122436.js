...
export default function App() {
  ...
  return (
    ...
    <div className="flex h-screen bg-zinc-950 text-zinc-100 font-inter antialiased overflow-hidden relative">
      ...
      <div className="hidden md:block fixed inset-y-0 left-0 w-[var(--panel-width-val)] z-10">
        <ScrollingHumorPanel
      ...
      <div className="hidden md:block fixed inset-y-0 right-0 w-[var(--panel-width-val)] z-10">
        <ScrollingHumorPanel
            humorItems={humorItems}
            direction="up"
            position="right"
      ...
      <Sheet open={isSidebarOpen} onOpenChange={setIsSidebarOpen}>
        {/* The SheetTrigger for mobile sidebar (Menu button in ChatHeader will need onClick to open this Sheet) */}
        {/* On desktop, this trigger is hidden */}
        ...
        <SheetContent
          side="left"
          // Class names for SheetContent: full overlay on mobile, static on desktop
          className="w-64 bg-zinc-900 border-r-4 border-pink-700 shadow-2xl z-40 flex flex-col py-6 px-4
                     ...
                     md:translate-x-0 md:static md:flex" // md:static md:flex to make it appear on desktop
        >
      ...
      <div className={`flex flex-col flex-1 relative z-20 
        ...
        <ChatHeader
          ...
          toggleSidebar={() => setIsSidebarOpen(!isSidebarOpen)} // This passes the App.js state setter
