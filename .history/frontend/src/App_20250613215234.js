...
export default function App() {
  ...
  // FIX: Renamed selectedVoiceStyle to selectedPersonaMode consistently
  const [selectedPersonaMode, setSelectedPersonaMode] = useState('Default brocodeAI'); // Default persona mode for personality modes
    ...
    <div className="flex h-screen bg-zinc-950 text-zinc-100 font-inter antialiased overflow-hidden relative">
      ...
      <div className={`hidden md:block fixed inset-y-0 left-0 w-[var(--panel-width-val)] z-10 top-[var(--header-height)] bottom-0`}>
        <ScrollingHumorPanel
            ...
            selectedVoiceStyle={selectedVoiceStyle} // Using selectedVoiceStyle for TTS
        />
      </div>
      ...
      <div className="flex flex-col flex-1 relative z-20 
        ...
        <ChatHeader
          ...
          selectedVoiceStyle={selectedVoiceStyle} // Pass selectedVoiceStyle
          onSelectVoiceStyle={setSelectedVoiceStyle} // Pass setter for voice style
          selectedPersonaMode={selectedPersonaMode} // Pass selectedPersonaMode
          onSelectPersonalityMode={setSelectedPersonaMode} // Pass setter for persona mode
