    ...
    <div className="flex h-screen bg-zinc-950 text-zinc-100 font-inter antialiased overflow-hidden relative">
      ...
      <div className="flex flex-col flex-1 relative z-20 
        ...
        <ChatHeader
          ...
          selectedVoiceStyle={selectedVoiceStyle} // Still pass selectedVoiceStyle to ChatHeader
          onSelectVoiceStyle={setSelectedPersonaMode} // Pass setSelectedPersonaMode setter to ChatHeader
