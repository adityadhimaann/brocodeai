...
export default function App() {
  ...
  // --- NEW/UPDATED: Centralized Audio Playback Function ---
  // This function tries to play audio using an <audio> element to be more robust against autoplay blocks.
  const playAudioFromBase64 = useCallback(async (base64Audio, source = "chat") => {
    ...
    try {
        ...
        console.error(`[playAudioFromBase64] Failed to play audio for ${source} (likely autoplay blocked or audio invalid):`, e);
    ...
    // Clean up the audio element after it finishes playing or errors
    audioElement.onended = () => audioElement.remove();
    audioElement.onerror = () => audioElement.remove();
  }, [displayMessageBox]);
  ...
  // Function to toggle auto-speak state
