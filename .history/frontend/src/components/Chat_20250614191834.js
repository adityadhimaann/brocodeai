...
export default function Chat({
  ...
  const generateBrocodeMeme = async () => {
    try {
      ...
      displayMessageBox(data.meme || 'Here is your meme!', 'info');
      // Optionally, you can add the meme to messages or show a modal
    } catch (error) {
      displayMessageBox(`Meme error: ${error.message}`, 'error');
    }
  };
