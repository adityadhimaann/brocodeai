...
import { ChevronDown, Menu, User, LogIn, LogOut, Flame, Volume2, VolumeX, Medal, MessageSquareMore, SlidersHorizontal } from 'lucide-react'; // Added SlidersHorizontal for Modes button
...
export default function ChatHeader({
  ...
  toggleSidebar,
  loggedInUser, onLogin, onLogout,
  isAutoSpeakEnabled, onToggleAutoSpeak,
  onGenerateRoast, // Still passed but called from dropdown
  onUnlockAchievement, // Still passed but called from dropdown
}) {
