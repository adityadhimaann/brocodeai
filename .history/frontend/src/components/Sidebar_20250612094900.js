...
import { Settings, History, Plus, X, Search, MoreVertical, LogOut, User } from 'lucide-react'; // Flame icon removed

export default function Sidebar({ isOpen, toggleSidebar, onSelectChat, clearMessages, displayMessageBox /* onGenerateRoast prop removed */ }) {
  ...
  // handleRoastMeClick and its connection to onGenerateRoast are removed
  // as the Roast Me button is moved to ChatHeader.
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* Roast Me Button REMOVED FROM HERE */}
