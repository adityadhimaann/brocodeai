...
export default function MessageList({ messages, isLoading, playReceivedAudio }) {
  ...
  return (
    <div className="flex-1 bg-zinc-900">
      <div className="h-full max-h-[70vh] overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && (
        <motion.div
              ...
              >
                ...
                {msg.sender === 'brocodeAI' && msg.audio && (
                  <motion.button
                    ...
                    className="mt-3 px-3 py-1  hover:bg-teal-600 text-teal-300 hover:text-white text-sm font-semibold rounded-md flex items-center space-x-1 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-zinc-700 transition-colors duration-200"
