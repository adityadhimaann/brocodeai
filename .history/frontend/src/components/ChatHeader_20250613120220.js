...
import { ChevronDown, Menu, User, LogIn, LogOut, Flame, Volume2, VolumeX, Medal } from 'lucide-react'; // Menu is now just an icon, not a trigger

// Shadcn UI Components
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger } from './ui/dropdown-menu';
// Removed SheetTrigger import as it's no longer used here
...
export default function ChatHeader({
  ...
  return (
    ...
    >
      {/* Left side: Menu Icon (no longer a trigger) and Roast Me! Button */}
      <div className="flex items-center space-x-2 md:space-x-4">
        {/* The Menu icon is now just for display. The actual SheetTrigger is in App.js */}
        <div
          className="p-1 md:p-2 rounded-full bg-zinc-700 text-white cursor-pointer md:hidden" // Hidden on desktop
          // Removed onClick handler as it no longer toggles the Sheet directly
