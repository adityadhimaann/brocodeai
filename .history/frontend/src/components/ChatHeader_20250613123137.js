...
export default function ChatHeader({
  ...
  // toggleSidebar prop removed from ChatHeader as SheetTrigger is now in App.js
  ...
  return (
    ...
    >
      {/* Left Block: Menu Icon (no longer a trigger) and Roast, Achievement buttons */}
      <div className="flex items-center gap-x-2 flex-shrink-0"> {/* flex-shrink-0 prevents shrinking */}
        {/* The Menu icon is now just for display. SheetTrigger is in App.js. */}
        {/* It should be visible on mobile, so no md:hidden here directly */}
        <div
          className="p-1 md:p-2 rounded-full bg-zinc-700 text-white cursor-pointer"
          title="Open Sidebar (Click the 3 lines in the top left)"
          // The actual SheetTrigger is wrapping this button in App.js
        >
      ...
      {/* mx-auto will center it within the available space between flex items */}
