          ...
          <DropdownMenuContent className="w-40 md:w-48 bg-zinc-700 rounded-lg shadow-2xl border border-zinc-600 overflow-hidden">
            {loggedInUser ? (
              ...
              <DropdownMenuItem
                ...
                className="block w-full text-left px-4 py-2 text-xs md:text-sm font-medium text-teal-300 hover:bg-teal-600 hover:text-white transition-colors duration-200  items-center space-x-1 md:space-x-2"
              >
