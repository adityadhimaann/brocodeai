...
export default function Chat({
  ...
  return (
    <div className="flex flex-col h-screen relative z-20">
      ...
      <div className="flex flex-col flex-1 pt-[var(--header-height)] mx-auto w-full max-w-[calc(100%-2*var(--panel-width-val))] md:max-w-3xl p-2 sm:p-4">
        {systemMessage && (
        ...
        <div className="flex-1 flex justify-center p-2 sm:p-4 overflow-hidden">
          <div className="w-full h-full bg-zinc-900 rounded-xl shadow-2xl border-2 border-zinc-700 flex flex-col overflow-hidden">
            <MessageList
              messages={messages}
              isLoading={isLoading}
