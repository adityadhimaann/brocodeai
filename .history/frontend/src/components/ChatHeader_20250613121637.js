  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        {/* This button will be controlled by App.js's SheetTrigger in App.js */}
        {/* Its onClick now directly toggles the App.js state */}
        <motion.button
          onClick={toggleSidebar} // This will directly set isSidebarOpen in App.js
