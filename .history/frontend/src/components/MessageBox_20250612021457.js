...
import { X, Info, AlertTriangle } from 'lucide-react'; // Lucide icons for close and type
    ...
    <AnimatePresence>
      {message && (
        <motion.div
          ...
          className="fixed top-4 left-1/2 -translate-x-1/2 z-50 p-2 rounded-lg shadow-2xl border-2"
