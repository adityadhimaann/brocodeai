      ...
      {messages.length === 0 && (
        ...
        >
          <p className="text-2xl font-bold text-teal-400 mb-2">
            Engaging AI Protocol Initiated.
          </p>
          <p className="text-lg text-zinc-300">
            Welcome to brocodeAI! How can I humorously assist you today?
          </p>
        ...
        {messages.map((msg, index) => (
          ...
          >
            ...
            >
              ...
              <p className="text-lg break-words whitespace-pre-wrap">{msg.text}</p>
        ...
        <div className="flex justify-start">
          <div className="max-w-md p-4 rounded-2xl rounded-bl-none bg-zinc-700 text-zinc-100 shadow-xl border border-zinc-600">
            ...
            <div className="flex items-center space-x-2 mt-2">
              <div className="h-3 w-3 bg-pink-500 rounded-full animate-ping delay-100"></div>
              <div className="h-3 w-3 bg-pink-500 rounded-full animate-ping delay-200"></div>
              <div className="h-3 w-3 bg-pink-500 rounded-full animate-ping delay-300"></div>
