...
export default function ChatHeader({
  ...
  toggleSidebar, // This prop will now directly toggle the isSidebarOpen state in App.js
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-x-2 flex-shrink-0"> {/* flex-shrink-0 prevents shrinking */}
        {/* The Menu button now directly toggles the isSidebarOpen state in App.js */}
        <motion.button
