...
import { ChevronDown, Menu, User, LogIn, LogOut, Flame, Volume2, VolumeX, Medal, MessageSquareMore } from 'lucide-react'; // Added MessageSquareMore
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-x-1 md:gap-x-3 mx-auto flex-shrink-0">
        {/* Replaced <img> with MessageSquareMore icon */}
        <MessageSquareMore
          className="h-6 w-6 md:h-8 md:w-8 text-pink-500 animate-pulse-slow rounded-full border-2 border-pink-500 p-0.5" // Added styling to mimic image border
          alt="brocodeAI Logo" // Alt text remains for accessibility
        />
