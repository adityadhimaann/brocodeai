...
import { SheetClose } from './ui/sheet'; // Import SheetClose directly (will be used in App.js)
import { DialogTitle, DialogDescription } from './ui/dialog';


// This component now purely renders the content of the sidebar.
// The Sheet and SheetContent wrappers are moved to App.js
export default function Sidebar({ toggleSidebar, onSelectChat, clearMessages, displayMessageBox }) {
  ...
  const handleNewInteraction = () => {
    ...
    // toggleSidebar(); // SheetClose handles closing if this is inside Sheet
  };
  ...
  return (
    <> {/* No Sheet or SheetContent here, just the content */}
      {/* Sidebar Header */}
      <div className="flex justify-between items-center mb-6 border-b pb-4 border-zinc-700">
        ...
        <SheetClose asChild> {/* SheetClose is valid here because Sidebar is rendered inside SheetContent in App.js */}
          <motion.button
