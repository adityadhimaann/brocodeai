      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-y-0 left-0 w-64 md:w-64 bg-zinc-900 border-r-4 border-pink-700 shadow-2xl z-40 flex flex-col py-6 px-4
                       md:relative md:flex" {/* Changed from fixed to relative on md+ screens */}
          >
            {/* Sidebar Header */}
            <div className="flex justify-between items-center mb-6 border-b pb-4 border-zinc-700">
              ...
              <motion.button
                onClick={toggleSidebar}
                className="p-2 rounded-full bg-pink-700 hover:bg-pink-600 text-white focus:outline-none focus:ring-2 focus:ring-pink-500 transition-colors duration-200 md:hidden" {/* Hide close button on desktop */}
