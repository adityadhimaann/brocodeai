...
import { ChevronDown, MessageSquareMore, Menu, User, LogIn, LogOut, Flame } from 'lucide-react'; // Added Flame icon
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-4">
        ...
        {/* New Roast Me Button in Header */}
        <motion.button
          onClick={onGenerateRoast}
          className="px-4 py-2 bg-red-800 hover:bg-red-700 text-white font-bold rounded-lg shadow-lg flex items-center space-x-2 focus:outline-none focus:ring-4 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-zinc-800 transition-colors duration-200 text-sm"
