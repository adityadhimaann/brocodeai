...
export default function ScrollingHumorPanel({ humorItems = [], direction = 'up', position = 'left', isLoading, error, onRefresh }) {
  ...
  // FIX: Set CSS variables directly
  ...
  return (
    ...
    >
      ...
      {isLoading ? (
        ...
        >
          <div
            className="w-full absolute inset-0 will-change-transform scrolling-content" // Added scrolling-content class
            style={scrollingStyle} // Apply CSS variables via style prop
          >
