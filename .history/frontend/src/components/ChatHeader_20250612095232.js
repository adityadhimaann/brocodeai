...
import { ChevronDown, MessageSquareMore, Menu, User, LogIn, LogOut, Flame } from 'lucide-react';

export default function ChatHeader({ languages, selectedLanguage, onSelectLanguage, toggleSidebar, loggedInUser, onLogin, onLogout, onGenerateRoast }) {
    ...
    >
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        ...
        >
          ...
          <span className="hidden sm:inline">Roast Me!</span> {/* Hide text on very small screens */}
        </motion.button>
      </div>


      {/* Center: brocodeAI Branding */}
      {/* Centering adjusted for mobile */}
