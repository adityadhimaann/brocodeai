...
import { Settings, History, Plus, X, Search, MoreVertical, LogOut } from 'lucide-react';

// Shadcn UI Components
import { Button } from './ui/button';

export default function Sidebar({ toggleSidebar, onSelectChat, clearMessages, displayMessageBox, onLogout }) {
