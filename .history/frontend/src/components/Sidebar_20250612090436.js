            ...
            <div className="relative ml-auto">
              ...
              <AnimatePresence>
                {showHistoryOptions && (
                  ...
                  >
                    <button className="block w-full text-left px-4 py-2 text-sm text-zinc-200 hover:bg-zinc-600 transition-colors duration-150">
                      <Search className="inline-block h-4 w-4 mr-2" /> Search History
                    </button>
                    <button className="block w-full text-left px-4 py-2 text-sm text-zinc-200 hover:bg-zinc-600 transition-colors duration-150">
                      <History className="inline-block h-4 w-4 mr-2" /> All Interactions
                    </button>
                    <button className="block w-full text-left px-4 py-2 text-sm text-red-400 hover:bg-zinc-600 transition-colors duration-150">
