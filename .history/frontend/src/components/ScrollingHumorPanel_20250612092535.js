...
export default function ScrollingHumorPanel({ humorItems = [], direction = 'up', position = 'left', isLoading, error, onRefresh }) {
  ...
  // FIX: Break down 'animation' shorthand into longhand properties
  const animationStyle = {
    animationName: animationName,
    animationDuration: scrollDuration,
    animationTimingFunction: 'linear',
    animationIterationCount: 'infinite',
    animationPlayState: isHovered ? 'paused' : 'running', // This is now explicitly set and doesn't conflict
  };
      ...
      {isLoading ? (
        ...
        >
          <div
            ...
            style={animationStyle} // Use the fixed animationStyle
          >
