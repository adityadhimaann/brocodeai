...
import { ChevronDown, MessageSquareMore, Menu, User, LogIn, LogOut, Flame, Volume2, VolumeX } from 'lucide-react'; // Added VolumeX for mute icon

export default function ChatHeader({
  languages, selectedLanguage, onSelectLanguage,
  selectedVoiceStyle, onSelectVoiceStyle,
  toggleSidebar, loggedInUser, onLogin, onLogout, onGenerateRoast,
  isAutoSpeakEnabled, onToggleAutoSpeak // NEW PROPS
}) {
