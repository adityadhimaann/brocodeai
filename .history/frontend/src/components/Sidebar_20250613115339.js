...
import { Button } from './ui/button'; // Assuming relative import path
// Removed SheetClose import as it's no longer used here
import { DialogTitle, DialogDescription } from './ui/dialog'; // Import for accessibility titles


// This component now purely renders the content of the sidebar.
// The Sheet, SheetContent, and SheetClose wrappers are moved to App.js
export default function Sidebar({ toggleSidebar, onSelectChat, clearMessages, displayMessageBox }) {
  ...
  const handleNewInteraction = () => {
    ...
    // No need to toggleSidebar() directly here, the SheetsClose button in App.js will close the sheet
  };
  ...
  return (
    ...
    <>
      ...
      <div className="flex justify-between items-center mb-6 border-b pb-4 border-zinc-700">
        ...
        {/* Manual close button (will trigger toggleSidebar prop from App.js) */}
        <motion.button
          onClick={toggleSidebar} // This now directly calls the toggleSidebar prop
