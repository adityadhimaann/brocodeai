...
import { motion } from 'framer-motion'; // motion is used implicitly by Framer Motion components
...
import Sidebar from './components/Sidebar.js'; // Sidebar component will now handle its own rendering/animation
...
import { Loader2 } from 'lucide-react'; // Loader2 is used in the loading spinner

// Firebase imports for client-side
import { initializeApp, getApps, getApp } from 'firebase/app';
import { getAuth, signInAnonymously, signInWithCustomToken, onAuthStateChanged } from 'firebase/auth';

// REMOVED Shadcn Sheet imports as we are no longer using it for the sidebar
// import { Sheet, SheetContent, SheetTrigger, SheetClose } from './components/ui/sheet';
// import { Button } from './components/ui/button'; // Button is still used by other components
import { DialogTitle, DialogDescription } from './components/ui/dialog'; // Still needed for other dialogs (Modals)
...
export default function App() {
  ...
  const [isSidebarOpen, setIsSidebarOpen] = useState(false); // Controls custom sidebar visibility
