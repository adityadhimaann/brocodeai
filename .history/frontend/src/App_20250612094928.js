...
export default function App() {
  ...
  // sarcasmSuggestions state can be removed if they are completely gone from UI
  const [sarcasmSuggestions] = useState([ // Kept as static for now, but will be removed from UI.
    "Oh, how original.",
  ...
  return (
    <div className="flex h-screen bg-zinc-950 text-zinc-100 font-inter antialiased overflow-hidden relative">
      ...
      <Sidebar
        ...
        // onGenerateRoast prop removed from Sidebar
      />
      ...
      <div className={`flex flex-col flex-1 transition-all duration-300 ease-in-out ${mainContentMl} ${isSidebarOpen ? '' : 'md:ml-80'} md:mr-80 z-20`}>
        <ChatHeader
          ...
          onGenerateRoast={generateRoast} // Pass roast generation function to ChatHeader
        />
        ...
        <div className="flex justify-center p-4 pt-0">
            <MessageInput
                ...
                isLoading={isLoading}
                sarcasmSuggestions={sarcasmSuggestions} // This prop is still passed but MessageInput won't use it for display
