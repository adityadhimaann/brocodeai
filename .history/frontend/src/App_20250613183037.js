...
export default function App() {
  ...
  const [personalityMode, setPersonalityMode] = useState('default_ai'); // NEW: State for personality mode
    ...
    try {
      const response = await fetch('http://localhost:5002/chat', {
        ...
        body: JSON.stringify({
          ...
          user_id: userId,
          app_id: __app_id,
          personality_mode: personalityMode, // NEW: Pass personalityMode to backend
        }),
      });
