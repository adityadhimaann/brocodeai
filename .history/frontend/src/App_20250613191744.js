    ...
    <div className="flex h-screen bg-zinc-950 text-zinc-100 font-inter antialiased overflow-hidden relative">
      ...
      <Sheet open={isSidebarOpen} onOpenChange={setIsSidebarOpen}>
        ...
        <SheetTrigger asChild>
          ...
          <motion.button
            className="p-1 md:p-2 bg-zinc-700 hover:bg-zinc-600 text-white focus:outline-none focus:ring-2 focus:ring-zinc-600 transition-colors duration-200 absolute top-3 left-3 md:hidden z-50" // Removed rounded-full
