...
export default function App() {
  ...
  // FIX: fetchHumor now fetches content for both panels
  ...
  useEffect(() => {
    if ('SpeechRecognition' in window || 'webkitSpeechRecognition' in window) {
      ...
      recognitionRef.current.lang = selectedLanguage === 'hinglish' ? 'hi-IN' : selectedLanguage; // Ensure lang is always valid
    ...
    try {
      const response = await fetch('http://localhost:5002/chat', {
        ...
        body: JSON.stringify({
          ...
          voice_style: selectedPersonaMode, // FIX: Pass selectedPersonaMode as voice_style
    ...
    <div className="flex h-screen bg-zinc-950 text-zinc-100 font-inter antialiased overflow-hidden relative">
      ...
      <div className="flex flex-col flex-1 relative z-20 
        ...
        <ChatHeader
          ...
          selectedVoiceStyle={selectedPersonaMode} // Pass selectedPersonaMode for TTS voice selection
          onSelectVoiceStyle={setSelectedPersonaMode} // Pass setSelectedPersonaMode setter for voice style
          selectedPersonaMode={selectedPersonaMode} // Pass persona mode for dropdown display
          onSelectPersonalityMode={setSelectedPersonaMode} // Pass setter for persona mode dropdown
          toggleSidebar={() => setIsSidebarOpen(!isSidebarOpen)}
