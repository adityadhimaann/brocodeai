...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-zinc-950 text-zinc-100 font-inter antialiased overflow-hidden relative" style={{ '--panel-width-val': '300px', '--header-height': '64px' }}>
      ...
      {/* Main Chat UI - always full width on mobile */}
      <div className="flex-1 flex flex-col w-full max-w-full mx-auto p-0 sm:p-2 md:p-4" style={{ minHeight: 0 }}>
        <Chat
          messages={messages}
          ...
          displayMessageBox={displayMessageBox}
          toggleSidebar={() => setIsSidebarOpen(!isSidebarOpen)}
          showHumorPanels={showHumorPanels && window.innerWidth >= 768} // Only show side panels on desktop
